...
//   // Get clusters and small groups for filter dropdowns (these would normally be fetched from API)
//   const clusters = [
...
//     router.push(`/dashboard/members?${newParams.toString()}`)
//   }
...
//                   </SelectTrigger>
//                   <SelectContent>
//                     <SelectItem value="">All Small Groups</SelectItem>
...
//                       size="icon"
//                       className="h-4 w-4 p-0 ml-1"
//                       onClick={() => handleFilterChange("clusterId", "")}
//                     >
//                       <X className="h-3 w-3" />
//                     </Button>
//                   </Badge>
...
//                       size="icon"
//                       className="h-4 w-4 p-0 ml-1"
//                       onClick={() => handleFilterChange("smallGroupId", "")}
//                     >
//                       <X className="h-3 w-3" />
//                     </Button>
//                   </Badge>
