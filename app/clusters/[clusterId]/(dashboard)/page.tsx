  ...
  return (
    <div className="space-y-6 p-6">
      ...
      <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mt-6`}>
        ...
        <DataCard title="Small Groups" value={smallGroupCountInCluster.toString()} icon={<UsersIcon />} description="Small groups in this cluster" />
      ...
      {/* Further DataCards or lists relevant to cluster */}
       <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <DataCard
          ...
          action={{ label: "View All Small Groups", href: `/clusters/${clusterId}/dashboard/small-groups` }}
        >
        ...
        <DataCard
          ...
          action={{ label: "View All Events", href: `/clusters/${clusterId}/dashboard/events` }}
        >
